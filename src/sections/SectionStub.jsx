    ...
    >
      <div className="mx-auto max-w-7xl">
        <div className="glass-panel max-w-3xl rounded-[2rem] p-8 sm:p-10">
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-[-0.05em] text-zinc-900 transition-colors duration-500 dark:text-zinc-100 sm:text-5xl">
            {title}
          </h2>
          <p className="mt-4 max-w-2xl text-base leading-8 text-zinc-600 transition-colors duration-500 dark:text-zinc-300 sm:text-lg">
            {copy}
          </p>
        </div>
      </div>
